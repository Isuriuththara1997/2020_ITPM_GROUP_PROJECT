		...
		try {
			...
			while (it.hasNext()) {
				...
				if (isFormField) {
					...
					String destination="C:\\Users\\isuri\\git\\ITPM_Group_Project_2020\\ITPM_Final_Group_Project_16\\uploads\\"+fileItem.getName();
			...
			out.println("window.location.href='result.jsp?filename=" + file_name + "'");
			out.println("</script>");
			out.close();
		}
	}
